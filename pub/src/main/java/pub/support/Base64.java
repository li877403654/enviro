...
public class Base64 {
    ...
    public static void main(String[] args) {
        String arg = args.length > 0? args[0]: "test";
        String encoded = encode(arg);
        System.out.println("encode: " + arg + " -> (" + encoded + ")");
        System.out.println("decode: " + encoded + " -> (" + new String(decode(encoded)) + ")");
    }
}
