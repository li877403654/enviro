...
//        CheckArg.isNotEmpty(plural, "plural rule");
    ...
    protected void initialize() {
        ...
        addPluralizes(inflect);
        addSingularizes(inflect);
        addIrregulars(inflect);

        inflect.addUncountable("equipment", "information", "rice", "money", "species", "series", "fish", "sheep");
    }

    private void addIrregulars(Inflector inflect) {
    ...
    private void addSingularizes(Inflector inflect) {
    ...
    private void addPluralizes(Inflector inflect) {
