...
public final class CorsFilter implements Filter {
    ...
    protected void handlePreflightCORS(final HttpServletRequest request,
        ...
        if (requestType != CORSRequestType.PRE_FLIGHT) {
            throw new IllegalArgumentException("corsFilter.wrongType1");
        }
    ...
    protected static void decorateCORSProperties(
        ...
        if (request == null) {
            throw new IllegalArgumentException(
                    "corsFilter.nullRequest");
        }

        if (corsRequestType == null) {
            throw new IllegalArgumentException(
                    "corsFilter.nullRequestType");
        }
            ...
            if (originHeader.isEmpty()) {
                ...
                if (method != null) {
                    if ("OPTIONS".equals(method)) {
                        ...
                        requestType = CORSRequestType.SIMPLE; //xxx
        ...
        if (preflightMaxAge != null) {
            try {
                ...
                throw new ServletException(
                        "corsFilter.invalidPreflightMaxAge");
            }
        }
